...
public partial class TrainerPrograms : System.Web.UI.Page
{
    string sqlSelect;
    public DataSet ds;
    MyAdoHelper helper;
    ...
    public void getPrograms()
    {
        ...
        sqlSelect = "SELECT fldProgramId,fldProgramDuration,fldProgramType,fldProgramLevel,fldProgram FROM tblPrograms WHERE fldTrainerId='" + Session["username"] +"'";
